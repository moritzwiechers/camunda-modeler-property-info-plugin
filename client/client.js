         ...
         switch (extensions[extension].$type) {
            case 'camunda:ExecutionListener':
               if (extensions[extension].event === 'start') {
                  ...
                  sort = 20;
                  if (extensions[extension].expression && extensions[extension].expression.indexOf(
                     'execution.setVariable') > 0 && extensions[extension].expression.indexOf(
                     'TaskIstAsynchron') > 0 && extensions[extension].expression.indexOf('true') > 0) {
                     badges.push({
                        badgeKey: key + 'AS',
                        badgeSort: sort,
                        badgeType: 'AS',
                  ...
                  if (extensions[extension].expression && extensions[extension].expression.indexOf(
                     'execution.setVariable') > 0 && extensions[extension].expression.indexOf(
                     'TaskIstAsynchron') > 0 && extensions[extension].expression.indexOf('asyncForm') > 0) {
                     badges.push({
                        badgeKey: key + 'AS',
                        badgeSort: sort,
                        badgeType: 'AS',
                  ...
                  if (extensions[extension].expression && extensions[extension].expression.indexOf(
                     'execution.setVariable') > 0 && extensions[extension].expression.indexOf(
                     'asyncForm') > 0 && extensions[extension].expression.indexOf('false') > 0) {
                     badges.push({
                  ...
                  if (extensions[extension].expression && extensions[extension].expression.indexOf(
                     'execution.setVariable') > 0 && extensions[extension].expression.indexOf(
                     'asyncForm') > 0 && extensions[extension].expression.indexOf('true') > 0) {
                     badges.push({
                        badgeKey: key + 'AStrue',
                        badgeSort: sort,
                        badgeType: 'AS',
...
var plugin = __webpack_require__(/*! ./PropertyInfoPlugin */ "./client/PropertyInfoPlugin.js");
